...
import styles from './CifEventsDetails.module.css';
...
export default function CifEventsDetails() {
    ...
    const getAllFeedbacks = async () => {
        setLoading(true);
        try {
            const response = await myAppWebService.GetAllFeedbackdetails();
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, 'Feedback_Details.xlsx');
    };
    ...
    return (
        ...
        <Box sx={{ p: 4 }}>
            ...
            <Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
                <Typography variant="h5" gutterBottom align="center" fontWeight="bold">All Feedback Details</Typography>
                <Divider sx={{ mb: 3 }} />
                    ...
                    <Table stickyHeader size="small">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell className={styles.headerCell}>Coments </TableCell>
                                <TableCell className={styles.headerCell}>Suggestions </TableCell>
                                <TableCell className={styles.headerCell}>Rating </TableCell>
