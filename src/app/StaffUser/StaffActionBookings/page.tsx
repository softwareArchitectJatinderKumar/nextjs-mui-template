...
export default function StaffActionBookings() {
  ...
  //       // myAppWebService.GetUploadedResultDetails(auth.UserId)
  //       myAppWebService.GetUploadedResultDetails('33476')
  //     ]);

  //     const bookingList = bookings?.item1 || [];
...
// const isResultUploaded = (bookingId: string | number) => {
//   // Ensure bookingResults is an array before calling .some
//   if (!Array.isArray(bookingResults) || bookingResults.length === 0) {
//     return false;
//   }

//   return bookingResults.some(r => 
//     // Convert to string to ensure "600563" matches 600563
...
// };
  ...
  return (
    <div className="p-4">
      {loading && <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80">Loading...</div>}
      ...
      <div className="flex flex-wrap gap-4 mb-4 items-center justify-center bg-white p-6 rounded shadow-sm">
        <button 
